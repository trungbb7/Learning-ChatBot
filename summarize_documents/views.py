...
def summarize_api(request):
    ...
    if request.method == "POST" and request.FILES.get("file"):
        ...
        try:
            ...
            prompt = f""" 
                Tạo tóm tắt văn bản  của văn bản sau. Chú ý đến các điểm chính và thông tin quan trọng. Giữ tóm tắt rõ ràng và ngắn gọn (Chỉ trả về văn bản tóm tắt).
                có 3 mức độ tóm tắt là short, medium , long . Hãy tóm tắt theo mức độ ${summarize_type}               
                Văn bản: ${text}
                    """
            ...
            return JsonResponse({"summarized_text": summaried_text})
